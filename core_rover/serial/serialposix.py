...
class PosixSerial(SerialBase):
    ...
    def open(self):
        ...
        # open
        try:
            self.fd = os.open(self.portstr, os.O_RDWR|os.O_NOCTTY)  # Make it blocking by removing os.O_NONBLOCK
    ...
    def _reconfigurePort(self):
        ...
        if self._parity == PARITY_NONE:
            ...
            cflag |= (TERMIOS.PARENB| 0x40000000)   # TERMIOS.CMSPAR is 0b010000000000 @ http://www.lothosoft.ch/thomas/libmip/markspaceparity.php
            cflag &= ~(TERMIOS.PARODD)
        elif self.parity == PARITY_MARK:
            cflag |= (TERMIOS.PARENB|0x40000000|TERMIOS.PARODD) # TERMIOS.CMSPAR is 0b010000000000
        else:
    ...
    def read(self, size=1):
        """Read size bytes from the serial port. If a timeout is set it may
           ...
           PATCH: if size==1 and timeout occurs it raises SerialException"""
